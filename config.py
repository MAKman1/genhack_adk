...
API_BASE_URL = os.getenv("MONEYPENNY_API_BASE_URL", "http://localhost:3000/api")
...
GOOGLE_MAPS_API_KEY = os.getenv("GOOGLE_MAPS_API_KEY", "AIzaSyDfKlvLPWm0RsxDUnS6LRNMHBAHuGkQPRA")
